...
class DCG(nn.Module):
    def __init__(self, parameters):
        ...
        # fusion branch
        self.fusion_dnn = nn.Linear(self.experiment_parameters["post_processing_dim"]+1024, self.experiment_parameters["num_classes"], bias=False)
